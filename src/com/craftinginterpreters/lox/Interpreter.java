...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    private static Object uninitialized = new Object(); // an unitialized variable
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        if (method == null) {
            throw new RuntimeError(expr.method,
                    "Undefined property '" + expr.method.lexeme + "'."); // failure to find method
        }
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        if (stmt.superclass != null) {
            ...
            environment.define("super", superclass); // new env iff super class exists
        }
        ...
        // treat class methods seperately
        ...
        LoxClass metaklass = new LoxClass(null, stmt.name.lexeme + " metaclass", (LoxClass)superclass, classMethods);


        LoxClass klass = new LoxClass(metaklass, stmt.name.lexeme, (LoxClass)superclass, methods);
    ...
    public Object visitGetExpr(Expr.Get expr) {
        ...
        if (object instanceof LoxInstance) {
            ...
            if(result instanceof LoxFunction && ((LoxFunction) result).isGetter()) {
                result = ((LoxFunction) result).call(this, null); // class getter method
            }
